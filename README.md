...
| Meta Quest 2 through Air Link | **Working** | The current build can crash during startup. A fix is planned. Testing this route requires selecting the **SteamVR Beta** branch in Steam. SteamVR does not need to be opened manually; connect through Air Link and enable the SteamVR compatibility option in the World War VR launcher. |
